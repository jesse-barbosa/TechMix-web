<nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-700 min-h-screen max-w-1/6">
            ...
            <div class="flex flex-col w-full">
                ...
                <div class="flex items-center justify-center mt-4">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="Logo" class="block h-9 w-auto fill-current text-gray-200">
                    </a>
                </div>
